...
import { FaShoppingCart, FaHeart, FaStar, FaEye, FaShare, FaFilter, FaSort, FaSearch } from "react-icons/fa";
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Discover our latest products and innovations!</p>
            </div>
            <NavLink 
              to="/"
        ...
        {currentProducts.length > 0 ? (
              ...
              >
                ...
                <div className="absolute top-4 right-4 z-20 flex flex-col space-y-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  ...
                  <button
                    ...
                    className="p-2 rounded-full bg-white text-gray-600 hover:text-teal-600 hover:bg-teal-50 shadow-md hover:scale-110 transition-all duration-300"
                    aria-label="Share"
                  >
                ...
                <NavLink to={`/new-arrivals/${product._id}`} className="flex flex-col flex-grow">
                  {/* Product Image */}
                  <div className="relative p-6 flex justify-center items-center h-64 bg-gradient-to-br from-gray-50 via-white to-gray-100 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-green-50/50 to-teal-50/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
                    <img
                      src={product.image}
                      alt={product.name}
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <div className="flex justify-between items-start mb-3">
                      <h3 className="font-bold text-lg text-gray-900 line-clamp-2 group-hover:text-green-600 transition-colors duration-300 flex-1 mr-2">
                        {product.name}
                      </h3>
                      ...
                      <button
                        ...
                        className={`w-full py-3 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-3 group-hover:shadow-lg ${
                          hoveredCard === product._id
                            ...
                            : 'bg-gradient-to-r from-gray-100 to-gray-200 text-gray-800 hover:from-green-50 hover:to-teal-50 hover:text-green-600'
                        } btn-animate`}
                      >
                ...
                {/* Hover Glow Effect */}
                {hoveredCard === product._id && (
                  <div className="absolute inset-0 bg-gradient-to-t from-green-500/5 to-teal-500/5 pointer-events-none rounded-2xl z-10"></div>
                )}
              </div>
            ))}
          </div>
          ...
          <div className="text-center py-20 animate-fade-in">
            ...
            <p className="text-gray-600 max-w-md mx-auto text-lg leading-relaxed">
              Try adjusting your filters or check back soon for our latest products!
            </p>
            <button 
              onClick={() => {
                setSearchTerm("");
              ...
              className="mt-6 px-8 py-3 bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-full font-semibold hover:from-green-700 hover:to-teal-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Clear Filters
            </button>
          </div>
