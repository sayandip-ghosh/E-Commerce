    ...
    <section className="py-12 px-4 bg-[#E2D4C0]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">Our most popular products loved by thousands of customers</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {products && products.length > 0 ? (
            ...
            <div className="col-span-full text-center py-16">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-2">No Best Sellers Available</h3>
              <p className="text-gray-600 max-w-md mx-auto">Check back later for our top products and special offers</p>
            </div>
          )}
        </div>
      </div>
