        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Our most popular and trusted products!</p>
            </div>
            <NavLink 
              to="/"
        ...
        {currentProducts.length > 0 ? (
          ...
          <div className="text-center py-20 animate-fade-in">
            ...
            <p className="text-gray-600 max-w-md mx-auto text-lg leading-relaxed">
              Try adjusting your filters or search terms to find our best sellers!
            </p>
            <button 
              onClick={() => {
                setSearchTerm("");
              ...
              className="mt-6 px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-full font-semibold hover:from-green-700 hover:to-emerald-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Clear Filters
            </button>
          </div>
