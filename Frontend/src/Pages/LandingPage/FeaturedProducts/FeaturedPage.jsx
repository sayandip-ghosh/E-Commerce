        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Discover our handpicked selection of premium products!</p>
            </div>
            <NavLink 
              to="/"
        ...
        {currentProducts.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {currentProducts.map((product, index) => (
              ...
              >
                ...
                <NavLink to={`/featured/${product._id}`} className="flex flex-col flex-grow">
                  {/* Product Image */}
          ...
          <div className="text-center py-20 animate-fade-in">
            ...
            <p className="text-gray-600 max-w-md mx-auto text-lg leading-relaxed">
              Try adjusting your filters or search terms to find our featured products!
            </p>
            <button 
              onClick={() => {
                setSearchTerm("");
              ...
              className="mt-6 px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Clear Filters
            </button>
          </div>
